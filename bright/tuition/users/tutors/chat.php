...
echo "<tr><td>  $student_name  </td><td>  $student_id  </td><td>";?></td><td><button class="btn btn-outline-success"><a  style="font-size:13px;text-decoration:none;color:black;" href="../../chatroom_tutors.php?id=<?php  echo $student_id;?>">Chat</a></button></td></tr>
<?php
  }
