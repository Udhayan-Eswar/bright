            ...
            if($education==null)
            {
              echo "please fill the education";
                ...
                if(strlen($phone)<10)
                {
                  ...
                  $result = mysqli_query($con,"select email from students");
                 ...
                 $query = "INSERT INTO students (name,gender,email,password,age,education,phone) VALUES ('$name','$gender','$email','$password','$age','$education','$phone')";
